...
export const siteProfileSchema = z.object({
    ...
    contactHeroColor: z.string().regex(/^#[0-9a-fA-F]{6}$/, "Invalid hex color").optional(),
    reviewsHeroImage: z.string().optional(),
    reviewsHeroColor: z.string().regex(/^#[0-9a-fA-F]{6}$/, "Invalid hex color").optional(),
