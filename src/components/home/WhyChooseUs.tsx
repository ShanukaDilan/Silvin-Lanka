...
import { Leaf, ShieldCheck, Tag, Map, Star, Heart, CheckCircle, Info } from "lucide-react";
...
const iconMap: Record<string, any> = {
    Leaf, ShieldCheck, Tag, Map, Star, Heart, CheckCircle, Info
};

export function WhyChooseUs({
    title = "Why Choose Silvin Lanka?",
    features = [
        {
            icon: "Leaf",
